	...
	<div v-if="calculator.show">
		...
		<div class="gridcontainer castom">
			<div class="row calcInfo">
				<div class="col-md-6">
					<span>тонны</span><span class="active">килограммы</span> 
					<input onfocus="this.select();" required="" type="number" v-model="weight" @input="weightCalc()"><label>Вес</label>
				</div>	

				<div class="col-md-6">
					<span>километры</span><span class="active">метры</span>
					<input onfocus="this.select();" required="" type="number" v-model="lenght" @input="lenghtCalc()"><label>Длина</label>
				</div>
				<div class="col-md-6">
					<span class="active">штуки</span>
					<input onfocus="this.select();" required="" type="number" v-model="count"  @input="countCalc()"><label>Количество</label>
				</div>	
				<div class="col-md-6">
					<span class="active">Тенге</span>
					<input onfocus="this.select();" required="" type="number" v-model="price"  @input="priceCalc()"><label>Итог</label>
				</div>
			</div>
		</div>
	</div>
			...
			products: [
				{
					...
					selected: '',
					items: [
						{name: "Арматура 10", pr_tonn: 0,pr_length: 11.7, weight: 0.617, toler: 0, pr_price: 0,},
						{name: "Арматура 12", pr_tonn: 0,pr_length: 11.7, weight: 0.888, toler: 0, pr_price: 0,},
						{name: "Арматура 14", pr_tonn: 0,pr_length: 11.7, weight: 1.210, toler: 0, pr_price: 0,},
						{name: "Арматура 16", pr_tonn: 0,pr_length: 11.7, weight: 1.580, toler: 0, pr_price: 0,},
						{name: "Арматура 18", pr_tonn: 0,pr_length: 11.7, weight: 2.000, toler: 0, pr_price: 0,},
						{name: "Арматура 20", pr_tonn: 0,pr_length: 11.7, weight: 2.470, toler: 0, pr_price: 0,},
						{name: "Арматура 22", pr_tonn: 0,pr_length: 11.7, weight: 2.980, toler: 0, pr_price: 0,},
						{name: "Арматура 25", pr_tonn: 0,pr_length: 11.7, weight: 3.850, toler: 0, pr_price: 0,},
						{name: "Арматура 28", pr_tonn: 0,pr_length: 11.7, weight: 4.830, toler: 0, pr_price: 0,},
						{name: "Арматура 32", pr_tonn: 0,pr_length: 11.7, weight: 6.310, toler: 0, pr_price: 0,},
						{name: "Арматура 36", pr_tonn: 0,pr_length: 11.7, weight: 7.990, toler: 0, pr_price: 0,},
					],
				}
			],
			product: {

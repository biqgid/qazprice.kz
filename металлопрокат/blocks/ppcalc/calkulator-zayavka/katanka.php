			...
			products: [
				{
					...
					selected: '',
					items: [
						{name: "Катанка 5 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: 0.154, toler: 0, pr_price: 0,},
						{name: "Катанка 5,5 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: 0.186, toler: 0, pr_price: 0,},
						{name: "Катанка 6 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: 0.222, toler: 0, pr_price: 0,},
						{name: "Катанка 6 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 0.222, toler: 0, pr_price: 0,},
						{name: "Катанка 6,5 (в мотках) ", pr_tonn: 0,pr_length: 11.7, weight: 0.26, toler: 0, pr_price: 0,},
						{name: "Катанка 6,5 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 0.26, toler: 0, pr_price: 0,},
						{name: "Катанка 8 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: 0.395, toler: 0, pr_price: 0,},
						{name: "Катанка 8 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 0.395, toler: 0, pr_price: 0,},
						{name: "Катанка 10 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: 0.616, toler: 0, pr_price: 0,},
						{name: "Катанка 10 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 0.616, toler: 0, pr_price: 0,},
					],
				}
			],
			product: {

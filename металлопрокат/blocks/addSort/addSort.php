<div style="display: flex">
	...
	<span id="combo3-remove" style="display: none"></span>

	<div class="combo js-multiselect">
		<input onfocus="this.select();" aria-activedescendant="" value="Добавить" aria-autocomplete="none" aria-controls="listbox3" aria-expanded="false" aria-haspopup="listbox" aria-labelledby="combo3-label combo3-selected" id="combo3" class="combo-input" role="combobox" type="text">
		<div class="combo-menu" role="listbox" id="listbox3"></div>
	</div>
	
</div>
<div class="w_div" style="margin: 0;">
...
Multiselect.prototype.onOptionClick = function (index) {
  ...
  this.updateMenuState(false);
	...
	Multiselect.prototype.selectOption = function(index) {
		...
		listItem.className = 'remove-option1';

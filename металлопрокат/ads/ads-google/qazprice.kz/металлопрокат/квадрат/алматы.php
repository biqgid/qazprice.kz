...
//------------------------------------------------
require '../ads/ads-google/kvadrat/0.php';
require '../ads/ads-google/kvadrat/1.php';
//------------------------------------------------
?>
	...
	<html>
		...
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<? require '../blocks/ppcalc/calkulator-zayavka/kvadrat.php'; ?>
						<hr>
						<div class="text">
							<h1><?php echo $h1; ?></h1>
							<h2><?php echo $h2; ?></h2>
					...
					<div class="col-md-7">
						...
						<div class="services" style="visibility: visible;">
							...
							<?php foreach($kvadrat as $product) : ?>

...
//------------------------------------------------
require '../ads/ads-google/krug/0.php';
require '../ads/ads-google/krug/1.php';
//------------------------------------------------
?>
...
<html lang="ru_RU">
	<html>
		<head>
			...
			<title>Круг стальной в Алматы с доставкой</title>
		...
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<? require '../blocks/ppcalc/calkulator-zayavka/krug.php'; ?>
						<hr>
						<div class="text">
							<h1><?php echo $h1; ?></h1>
							<h2><?php echo $h2; ?></h2>
					...
					<div class="col-md-7">
						<div class="img">
							<img src="../img/krug-frames/круг.png">
						</div>

...
//------------------------------------------------
require '../ads/ads-google/polosa/0.php';
require '../ads/ads-google/polosa/1.php';
require '../ads/ads-google/polosa/2.php';
//------------------------------------------------
?>
	...
	<html>
		...
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<? require '../blocks/ppcalc/calkulator-zayavka/polosa.php'; ?>
						<hr>
						<div class="text">
						    <h1><?php echo $h1; ?></h1>
							<h2><?php echo $h2; ?></h2>

  ...
  var i, e, n = "",
    ...
    l = {
      init: function(t) {
        ...
        return o.prependTo(s.cartLabel)[a || s.visibleLabel ? "show" : "hide"]().on("click", l.openCart).find(".jqcart-total-cnt").text(r), c(document).on("click", s.buttons, l.addToCart).on("click", ".jqcart-layout2", function(t) {
      ...
      sendOrder: function(t) {
        ...
        c.ajax({
          ...
          error: function() {},
          success: function(t) {
            c(".jqcart-checkout2").html("<p>" + t.message + "</p>"), t.errors || setTimeout(d.clearCart, 2e3)
          }
        })
      },
      printOrder: function() {
        var t = c(this).closest(".jqcart-checkout2").prop("outerHTML");
        if (!t) return !1;

...
//------------------------------------------------
require '../ads/ads-google/provoloka/0.php';
require '../ads/ads-google/provoloka/1.php';
require '../ads/ads-google/provoloka/2.php';
require '../ads/ads-google/provoloka/3.php';
//------------------------------------------------
?>
...
<html lang="ru_RU">
	<html>
		<head>
			...
			<title>Проволока в Алматы</title>
		...
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<? require '../blocks/ppcalc/calkulator-zayavka/provoloka.php'; ?>
						<hr>
						<div class="text">
							<h1><?php echo $h1; ?></h1>
							<h2><?php echo $h2; ?></h2>

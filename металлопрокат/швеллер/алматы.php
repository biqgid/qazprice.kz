...
//------------------------------------------------
require '../ads/ads-google/shveller/0.php';
require '../ads/ads-google/shveller/1.php';
require '../ads/ads-google/shveller/2.php';
require '../ads/ads-google/shveller/3.php';
require '../ads/ads-google/shveller/4.php';
require '../ads/ads-google/shveller/5.php';
require '../ads/ads-google/shveller/6.php';
require '../ads/ads-google/shveller/7.php';
require '../ads/ads-google/shveller/8.php';
require '../ads/ads-google/shveller/9.php';
//------------------------------------------------
?>
	...
	<html>
		...
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<? require '../blocks/ppcalc/calkulator-zayavka/shveller.php'; ?>
						<div class="text">
							<h1><?php echo $h1; ?></h1>
							<h2><?php echo $h2; ?></h2>
							<h3><?php echo $h3; ?></h3>
					...
					<div class="col-md-7">
						...
						<div class="services" style="visibility: visible;">
							...
							<?php foreach($shveller as $product) : ?>
							<p class="pp">Швеллер</p>

			...
			products: [
				{
					...
					selected: '',
					items: [
						{name: "Проволока ВР-1 / 2,7", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока ВР-1 / 3.0 (2,8)", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока ВР-1 / 3,8", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока ВР-1 / 4", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока ВР-1 / 4,8", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока ВР-1 / 5", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока вязальная ОК 1,2", pr_tonn: 0,pr_length: 11.7, weight: 65, toler: 0, pr_price: 0,},
						{name: "Проволока вязальная ОК 1,2", pr_tonn: 0,pr_length: 11.7, weight: 25, toler: 0, pr_price: 0,},
						{name: "Проволока вязальная ОК 3", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Проволока вязальная ОК 4", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},

			...
			products: [
				{
					...
					selected: '',
					items: [
						{name: "Катанка 5 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Катанка 5,5 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Катанка 6 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Катанка 6 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: , toler: 0, pr_price: 0,},
						{name: "Катанка 6,5 (в мотках) ", pr_tonn: 0,pr_length: 11.7, weight: ≈ 875, toler: 0, pr_price: 0,},
						{name: "Катанка 6,5 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 6,2, toler: 0, pr_price: 0,},
						{name: "Катанка 8 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: ≈ 900, toler: 0, pr_price: 0,},
						{name: "Катанка 8 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 6,2, toler: 0, pr_price: 0,},
						{name: "Катанка 10 (в мотках)", pr_tonn: 0,pr_length: 11.7, weight: ≈ 875, toler: 0, pr_price: 0,},
						{name: "Катанка 10 (тян. в прутах)", pr_tonn: 0,pr_length: 11.7, weight: 6,2, toler: 0, pr_price: 0,},
